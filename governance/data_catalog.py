"""
data_catalog.py — Data Catalog (Data Governance).

Automatically documents datasets, their schemas,
locations, and applied transformations.
"""
...
class DataCatalog:
    """Manages the project data catalog."""
    ...
    def publish_catalog(self):
        """Publishes the full catalog as a JSON file in MinIO."""
        catalog_doc = {
    ...
    def get_dataset_info(self, layer: str) -> dict:
        """Returns the documentation for a specific dataset."""
