"""
quality_report.py — Generates quality reports and stores them in MinIO.
"""
...
class QualityReporter:
    ...
    def save_report(self, summary: dict, date_str: str):
        """Saves the quality report as a JSON file in MinIO."""
        report = {
        ...
        logger.info("Quality report saved", extra={"key": key})
        return report
