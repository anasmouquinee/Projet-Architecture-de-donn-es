"""
AkhbaronaScraper — Scraper for the Moroccan news site Akhbarona.

Akhbarona is a Moroccan Arabic-language news portal.
It covers politics, economics, sports, and society.
"""
...
class AkhbaronaScraper(BaseScraper):
    """
    Specific scraper for Akhbarona (www.akhbarona.com).
    Arabic-language site covering Moroccan news.
    """
    ...
    def get_article_urls(self) -> list[str]:
        ...
        Akhbarona organises articles in blocks with direct links.
        """
        urls = []
        ...
        for link in article_links:
            ...
            # Akhbarona articles typically contain numeric IDs in the URL
            is_article = (
        ...
        self.logger.info("Akhbarona URLs found", extra={"count": len(urls)})
        return urls[:20]
