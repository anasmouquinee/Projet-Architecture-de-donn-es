"""
CNNScraper — Scraper for CNN International.

CNN is an American news network with global coverage.
This scraper targets edition.cnn.com.
"""
...
class CNNScraper(BaseScraper):
    """
    Specific scraper for CNN International (edition.cnn.com).
    ...
    def get_article_urls(self) -> list[str]:
        """
        Extracts article URLs from the CNN home page.
        CNN uses paths like /YYYY/MM/DD/section/slug/index.html.
        """
        urls = []
        ...
        self.logger.info("CNN URLs found", extra={"count": len(urls)})
        return urls[:20]
